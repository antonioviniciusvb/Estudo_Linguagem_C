...
#include<stdlib.h>
#include<string.h>
#include<locale.h> // Necessário para usar a setlocale
	...
	{ 
			...
			{		for(m=0;m<1;m++)
					{	
						if(m==0)
							{
									printf("%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c\n", 196,196,196,196,196,196, 196,196,196,196,196,196, 196,196,196,196,196,196, 196,196,196,196,196,196,196,196,196,196,196,196,196,196,196,196,196,196,196,196,191);
									printf("                           %c          %c", 194,179);
							}
						printf("\n                           %c          %c", 179,179);
					}
...
//Mostra o Resultado Final, caso algum time ganhe os 3 sets seguidos
